...
"""
    project_list: budget/project-list.html, Project.objects.all()

    project_detail: budget/project-detail.html
        'GET': {project,
                project.expenses.all(), category_list}
    ...
    ProjectCreateView: budget/add-project.html
                fields = ('name', 'budget')
"""
...
class TestViews(TestCase):
    ...
    def test_project_detail_POST_no_expense(self):
        # test-code
        response = self.client.post(self.detail_url)
